...
class Config(object):
    ...
    CLIENT_ID = os.environ.get(
        'CLIENT_ID') or '1d167055e97a90457fb88ef36fc814b8'
    ...
    CLIENT_SECRET_KEY = os.environ.get(
        'CLIENT_SECRET_KEY') or '36547f75e2c06b3f3e62c3d6cc59230253930d0a162ad848fe7c0c9e0c8eada4'
    #COMPILE_URL = os.environ.get('COMPILE_URL') or 'https://api.hackerearth.com/v3/code/compile/'
    COMPILE_URL = os.environ.get(
        'COMPILE_URL') or 'https://api.jdoodle.com/v1/execute'
    #RUN_URL = os.environ.get('RUN_URL') or 'https://api.hackerearth.com/v3/code/run/'
